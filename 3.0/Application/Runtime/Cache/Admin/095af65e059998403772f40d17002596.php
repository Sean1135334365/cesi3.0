...
<div class="inline page">
    ...
    <?php $__FOR_START_1769528953__=1;$__FOR_END_1769528953__=$page_number['count'];for($i=$__FOR_START_1769528953__;$i <= $__FOR_END_1769528953__;$i+=1){ if(($i > $page_number['page'] - 5) AND (($i < $page_number['page'] + 5) OR (($page_number['page'] <= 5) AND ($i <= 10)))): if($i == $page_number['page'] ): ?><a href="javascript:;" class="current"><?php echo ($i); ?></a>
                <?php else: ?>
